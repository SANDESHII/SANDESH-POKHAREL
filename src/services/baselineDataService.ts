...
const HISTORICAL_BASELINES: Record<string, TeamBaseline> = {
    ...
    "rb_leipzig": { npxG: 1.8, xT: 1.6, avgXG: 2.0, avgXGA: 1.1, cleanSheets: 9 },
    "psv_eindhoven": { npxG: 2.3, xT: 2.1, avgXG: 2.6, avgXGA: 0.7, cleanSheets: 15 },
    "feyenoord": { npxG: 1.9, xT: 1.8, avgXG: 2.2, avgXGA: 0.9, cleanSheets: 12 },
    "sporting_cp": { npxG: 2.1, xT: 1.9, avgXG: 2.4, avgXGA: 0.8, cleanSheets: 13 },
    "benfica": { npxG: 1.8, xT: 1.7, avgXG: 2.1, avgXGA: 1.0, cleanSheets: 11 },
    "porto": { npxG: 1.7, xT: 1.6, avgXG: 1.9, avgXGA: 0.9, cleanSheets: 12 },
    "galatasaray": { npxG: 2.1, xT: 1.9, avgXG: 2.4, avgXGA: 1.0, cleanSheets: 11 },
    "flamengo": { npxG: 1.7, xT: 1.5, avgXG: 1.8, avgXGA: 0.9, cleanSheets: 14 },
    "palmeiras": { npxG: 1.6, xT: 1.4, avgXG: 1.7, avgXGA: 0.8, cleanSheets: 15 },
    "river_plate": { npxG: 1.8, xT: 1.6, avgXG: 2.0, avgXGA: 1.1, cleanSheets: 10 }
};
