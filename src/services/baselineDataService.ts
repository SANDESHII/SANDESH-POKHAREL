...
export const TEAM_BASELINES: Record<string, TeamBaseline> = {
    ...
    "Everton": { npxG: 1.3, xT: 1.2, avgXG: 1.4, avgXGA: 1.3, cleanSheets: 13, purity: 1.0 },
    "Wolves": { npxG: 1.2, xT: 1.1, avgXG: 1.3, avgXGA: 1.7, cleanSheets: 6, purity: 1.0 },
    "Fulham": { npxG: 1.4, xT: 1.3, avgXG: 1.5, avgXGA: 1.6, cleanSheets: 10, purity: 1.0 },
    "Bournemouth": { npxG: 1.5, xT: 1.4, avgXG: 1.6, avgXGA: 1.8, cleanSheets: 9, purity: 1.0 },
    "Brentford": { npxG: 1.4, xT: 1.3, avgXG: 1.5, avgXGA: 1.7, cleanSheets: 7, purity: 1.0 },
    "Crystal Palace": { npxG: 1.3, xT: 1.2, avgXG: 1.4, avgXGA: 1.5, cleanSheets: 10, purity: 1.0 },
    "Nott'm Forest": { npxG: 1.2, xT: 1.1, avgXG: 1.3, avgXGA: 1.8, cleanSheets: 4, purity: 1.0 },
    "Luton": { npxG: 1.1, xT: 1.0, avgXG: 1.2, avgXGA: 2.1, cleanSheets: 2, purity: 1.0 },
    "Burnley": { npxG: 1.0, xT: 0.9, avgXG: 1.1, avgXGA: 2.0, cleanSheets: 2, purity: 1.0 },
    "Sheffield Utd": { npxG: 0.9, xT: 0.8, avgXG: 1.0, avgXGA: 2.5, cleanSheets: 1, purity: 1.0 },
